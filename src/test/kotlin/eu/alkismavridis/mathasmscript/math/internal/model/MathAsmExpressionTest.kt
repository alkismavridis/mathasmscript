package eu.alkismavridis.mathasmscript.math.internal.model

import org.assertj.core.api.Assertions.assertThat
import org.junit.jupiter.api.Test

class MathAsmExpressionTest {

    /// select tests
    @Test
    fun select_shouldDetectEdges() {
        val target = MathAsmExpression(longArrayOf(1,2,3,1,2), false)
        val searchTerm = MathAsmExpression(longArrayOf(1,2), false)

        val sel = ExpressionSelection(5)
    ...
    fun select_shouldDetectMiddle() {
        val target = MathAsmExpression(longArrayOf(1,2,3,1,2), false)
        val searchTerm = MathAsmExpression(longArrayOf(2,3), false)
    ...
    fun replace_shouldHandleEqualSizeReplacement() {
        val target = MathAsmExpression(longArrayOf(1,2,3,1,2), false)
        val searchTerm = MathAsmExpression(longArrayOf(1,2), false)
        val replacement = MathAsmExpression(longArrayOf(9,8), false)
    ...
    fun replace_shouldHandleShorterReplacement() {
        val target = MathAsmExpression(longArrayOf(1,2,3,1,2), false)
        val searchTerm = MathAsmExpression(longArrayOf(1,2), false)
        val replacement = MathAsmExpression(longArrayOf(9), false)
    ...
    fun replace_shouldHandleLargerReplacement() {
        val target = MathAsmExpression(longArrayOf(1,2,3,1,2), false)
        val searchTerm = MathAsmExpression(longArrayOf(1,2), false)
        val replacement = MathAsmExpression(longArrayOf(9,8,7,9), false)
    ...
    fun match_shouldDetectPositives() {
        val target = MathAsmExpression(longArrayOf(1,2,1,3,1,2,2,1,2), false)
        val searchTerm = MathAsmExpression(longArrayOf(1,2), false)
    ...
    fun match_shouldReturnFalseForLargerSearchTerms() {
        val target = MathAsmExpression(longArrayOf(1, 2), false)
        val searchTerm = MathAsmExpression(longArrayOf(1, 2, 1, 3, 1, 2, 2, 1, 2), false)
